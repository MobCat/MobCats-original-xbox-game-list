...
TL;DR we are no longer storing technically correct yet pointless `0x` prefix for Title IDs.<br>
This will brake some things, that where already hacked together. Now we can un hacky fix them.<br>
