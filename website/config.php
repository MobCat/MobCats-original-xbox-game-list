<?php
// CDN Setup
//TODO: figuer out if we can stop / 404 when someone trys to viset config.php manually in browser.
...
// If your feeling adventurous, you could build out this config to do auto fail over, or any number of checks.
